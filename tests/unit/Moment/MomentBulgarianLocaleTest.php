...
class MomentBulgarianLocaleTest extends TestCase
{
    ...
    public function testRelative()
    {
        ...
        self::assertEquals('след 2 минути', $endMoment->from($beginningMoment)->getRelative());
        self::assertEquals('преди 2 минути', $beginningMoment->from($endMoment)->getRelative());
    }
}
